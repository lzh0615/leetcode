...
import rotate from "./048-RotateImage.js";
import merge from "./056-mergeIntervals.js";
import generateMatrix from "./059-spiralMatrixII.js";
...
const main = () => { 
  ...
  // 059 螺旋矩阵
  const generateMatrixTest1 = generateMatrix(3)
  // 075  颜色分类
  const sortColorsTest1 = sortColors([2,0,2,1,1,0])
  // 119 杨辉三角 II
  const getRowTest1 = getRow(3)

  const test = generateMatrixTest1
  return test
}
console.log(main());
